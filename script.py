...
print 'Creando registro de revisiones donde se involucre el modulo %s...' % module
...
print 'Realizando merges restantes...'
for rev in invert:
    print '\n******************************************\n'
